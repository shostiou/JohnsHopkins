...
The performance of random forest is perfect (Accuracy = 1) we could then suspect overfitting. The accuracy on the test set is also nearly perfect.  

Based on the results of the cross validations, we will retain the Random Forest as the best model.  
